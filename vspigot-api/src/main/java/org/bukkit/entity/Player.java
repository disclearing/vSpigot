...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
     ...
     * @param signature We can add custom skins by doing this.
     */
    public void disguise(String name, String texture, String signature);

    /**
     * @see #disguise(String, String, String)
