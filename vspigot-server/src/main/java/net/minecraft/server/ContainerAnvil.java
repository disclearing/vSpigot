    ...
    public void e() {
        ...
        if (itemstack == null) {
            ...
            if (itemstack1 != null) {
                ...
                if (itemstack2 != null) {
                    PrepareAnvilRepairEvent event = new PrepareAnvilRepairEvent(
                            this.o.getBukkitEntity(),
                            getBukkitView(),
                            this.o.world.getWorld().getBlockAt(this.j, this.k, this.l),
                            CraftItemStack.asBukkitCopy(itemstack),
                            CraftItemStack.asBukkitCopy(itemstack2),
                            CraftItemStack.asBukkitCopy(itemstack1));

                    Bukkit.getPluginManager().callEvent(event);
                    if (event.isCancelled() || event.getResult().getType() == Material.AIR) {
                        return;
                    }
