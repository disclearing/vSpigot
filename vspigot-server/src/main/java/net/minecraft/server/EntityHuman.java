                ...
                if (flag3) {
                    if (i > 0) {
                        if (SpigotConfig.hcf) {
                            ...
                            Knockback knockback = getKnockback();
                            entity.g((-MathHelper.sin(this.yaw * 3.1415927F / 180.0F) * (float) i
                                    * knockback.getExtraHorizontal()), knockback.getExtraVertical(),
                                    (MathHelper.cos(this.yaw * 3.1415927F / 180.0F) *
                                            (float) i * knockback.getExtraHorizontal()));
                        }
