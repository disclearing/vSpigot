...
public abstract class EntityLiving extends Entity {
    ...
    public Knockback getKnockback() {
        return knockback == null ? SpigotConfig.defaultKnockback : knockback;
    }
...
//                boolean isRodTick = this.lastDamageSource == null && damagesource instanceof EntityDamageSourceIndirect && ((EntityDamageSourceIndirect)damagesource).getProximateDamageSource() instanceof EntityFishingHook
//                        || this.lastDamageSource != null && this.lastDamageSource instanceof EntityDamageSourceIndirect && !(((EntityDamageSourceIndirect)this.lastDamageSource).getProximateDamageSource() instanceof EntityFishingHook)
//                        && damagesource instanceof EntityDamageSourceIndirect && ((EntityDamageSourceIndirect) damagesource).getProximateDamageSource() instanceof EntityFishingHook;
                ...
                if (((!(shouldIgnoreArrow))) && this.noDamageTicks > maxNoDamageTicks / 2) {
                    ...
                    this.activatedTick = MinecraftServer.currentTick + this.maxNoDamageTicks * 2L; // Kohi
                }
    ...
    public void a(DamageSource damageSource, float f, double d0, double d1) {
        if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
            ...
            Knockback profile = getKnockback();
