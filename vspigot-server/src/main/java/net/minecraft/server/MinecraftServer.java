...
import net.valorhcf.autosave.AutoSave;
...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
        ...
        try {
            if (this.init()) {
                ...
                while (this.isRunning) {
                    ...
                    Bukkit.getServer().getPluginManager().callEvent(new ServerTickStartEvent(MinecraftServer.currentTick));

                    this.u();

                    long endTime = System.nanoTime();
                    double duration = (endTime - lastTick) / 1000000D;
                    long remaining = (TICK_TIME - (endTime - lastTick)) - catchupTime;

                    Bukkit.getServer().getPluginManager().callEvent(new ServerTickEndEvent(MinecraftServer.currentTick, duration, remaining));
    ...
    protected void u() throws ExceptionWorldConflict { // CraftBukkit - added throws
        ...
        */
        ...
        net.valorhcf.timings.ExtendedCustomTimingsHandler.tick(); // Poweruser
    }
