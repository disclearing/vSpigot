...
public class PacketPlayOutMultiBlockChange extends Packet {
    ...
    protected static PacketPlayOutMultiBlockChange create(final ChunkCoordIntPair b, final byte[] c, final int d, final short[] ashort, final int[] blocks) {
        final PacketPlayOutMultiBlockChange packetPlayOutMultiBlockChange = new PacketPlayOutMultiBlockChange();
        packetPlayOutMultiBlockChange.b = b;
        packetPlayOutMultiBlockChange.c = c;
        packetPlayOutMultiBlockChange.d = d;
        packetPlayOutMultiBlockChange.ashort = ashort;
        packetPlayOutMultiBlockChange.blocks = blocks;
    ...
    public String b() {
        return String.format("xc=%d, zc=%d, count=%d", this.b.x, this.b.z, this.d);
    }
