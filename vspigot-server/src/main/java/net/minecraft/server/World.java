...
import net.valorhcf.LightingUpdater;
import net.valorhcf.PlayerMap;
import net.valorhcf.ThreadingManager;
import net.valorhcf.ThreadingManager.TaskQueueWorker;
import net.valorhcf.WeakChunkCache;
import net.valorhcf.autosave.AutoSaveWorldData;
import net.valorhcf.generator.GeneratorConfig;
...
public abstract class World implements IBlockAccess {
    ...
    private Set<TileEntity> b = new HashSet<>();
    ...
    public final net.valorhcf.generator.GeneratorConfig generatorConfig;// MineHQ
    ...
    public void tickEntities() {
        ...
        if (!this.b.isEmpty()) {
            long aaa = tileEntityList.size();
            long bbb = this.b.size();
            ...
            if (ms > 50) {
                getServer().getLogger().warning(String.format(
                        "tileEntityList.removeAll took %s ms: %s, %s",
                        ms, aaa, bbb
                ));
            }
